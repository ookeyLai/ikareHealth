...
$article_arr = $itemArticle->get_articles($itemID,$userID);
$article_HiLow_arr = $itemArticle->get_article_HiLow($itemID,$userID);
...
?>
<script type='text/javascript' src='js4/highcharts.js'></script>
<script type='text/javascript'>
	...
	var options = {
			...
			subtitle: {
				text: '<?=$fromDate; ?> ~ <?=$toDate; ?> ( <?=$_RECORDS.": ".$pcnt; ?> )'
			},
			xAxis: {
				type: 'datetime',
			...
			tooltip: {
				...
				headerFormat: '<b>{point.x: %Y-%m-%d}</b><br><b>{point.x:%H:%M}</b><br>',
